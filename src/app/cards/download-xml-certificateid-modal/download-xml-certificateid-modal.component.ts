...
@Component({
  ...
  templateUrl: './download-xml-certificateid-modal.component.html',
  styleUrls: ['./download-xml-certificateid-modal.component.less']
})
export class DownloadXmlCertificateidModalComponent implements OnInit {
  readerId;
  pinpad;
  generatedFile;
  ...
  doSign(pinCode) {
    ...
    component.cardService.signDocumentWithCertificateId(component.generatedFile.id, component.readerId, pin, this.certid).then(() => {
