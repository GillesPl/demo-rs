    ...
    grunt.initConfig({
        ...
        copy: {
            dist: {
                ...
                cwd: "<%= dir.src %>",
                dest: "<%= dir.dest %>",
                src: ["index.html", "apublicfile.txt", "images/**/*", "fonts/**/*", "i18n/**/*", "views/**/*"]
            },
            local: {
                expand: true,
                cwd: "<%= dir.src %>",
                dest: "<%= dir.local %>",
                src: [ "images/**/*", "views/**/*", "fonts/**/*", "i18n/**/*", "styles/**/*", "scripts/plugins/**/*.js" ]
            },
            fa : {
                expand: true,
            ...
            faCss: {
                files: {
                    '<%= dir.dest %>/styles/font-awesome.min.css': 'node_modules/font-awesome/css/font-awesome.min.css'
                }
            },
            index: {
